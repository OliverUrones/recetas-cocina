...
//\Cake\Log\Log::write( 'debug', __METHOD__.'['.__LINE__.']'.' request.params= '.var_export( $this->request->params, true));
      ...
      if (($usuario !== null) && !empty($rol)) {
        ...
        if (!$res && (strcasecmp( $rol, 'A') == 0)  && $accion != 'cambiarRol' && $accion != 'hacerBackup' && $accion != 'restaurarBackup' /*Para el caso de que sólo el sysadmin pueda hacer copias de seguridad*/) {
          $res= true;
        }
