    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'MenuPlatos', 'action' => 'view', $menuPlatos->]) ?>

                    <?= $this->Html->link(__('Edit'), ['controller' => 'MenuPlatos', 'action' => 'edit', $menuPlatos->]) ?>

                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'MenuPlatos', 'action' => 'delete', $menuPlatos->], ['confirm' => __('Are you sure you want to delete # {0}?', $menuPlatos->)]) ?>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'RecetaCategorias', 'action' => 'view', $recetaCategorias->]) ?>

                    <?= $this->Html->link(__('Edit'), ['controller' => 'RecetaCategorias', 'action' => 'edit', $recetaCategorias->]) ?>

                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'RecetaCategorias', 'action' => 'delete', $recetaCategorias->], ['confirm' => __('Are you sure you want to delete # {0}?', $recetaCategorias->)]) ?>
