<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Imagenes de paso de la receta'), ['controller' => 'RecetaPasoImagenes', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('Nueva imagen de paso de la receta'), ['controller' => 'RecetaPasoImagenes', 'action' => 'add']) ?></li>
    </ul>
</nav>
