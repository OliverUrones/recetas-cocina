...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'categoria_padre_id' => ['type' => 'integer', 'length' => 12, 'unsigned' => true, 'null' => false, 'default' => '0', 'comment' => 'Identificador de la categoria padre en caso de estar ordenados por jerarquías.', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
