...
class IngredientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'datos_nutricion' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => '(opcional) Datos nutricionales del ingrediente', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'datos_nutricion' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.'
        ],
    ];
}
